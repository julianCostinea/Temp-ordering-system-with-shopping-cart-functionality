        ...
        <form action="cart.php" method="post" enctype="multipart/form-data">
          ...
          <div class="table-responsive">
            ...
            <div class="form-group row">
              <label for="code" class="col-sm-2 offset-sm-5 col-form-label font-weight-bold">Coupon Code</label>
              <div class="col-sm-2">
          ...
          if (!empty($code)) {
                    ...
                    if ($coupon_limit<$coupon_used) {
                      ...
                      if ($check_cart==1) {
                        ...
                        echo "<script>alert('Coupon product is not in cart')</script>";
                      }
                    }
                  }
                    else{
                      echo "<script>alert('Coupon is not valid')</script>";
                    }
                  }        
        }
      ?>
