      ...
      <div class="col-md-11">
        <div class="box">
          <div class="box-header text-center">
          	<h4>Enter your email, password will be sent to you shortly.</h4>
          </div> 
          <div class="text-center">
          	<form action="" method="post" class="pb-2">
          		<input type="text" name="c_email" class="form-control" placeholder="Enter Your Email"> <br>
          		<input type="submit" value="Send My Password" name="forgot_pass" class="btn btn-primary">
          	</form>
          </div>   
        </div>
      </div>
...
<?php 
	if (isset($_POST['forgot_pass'])) {
		...
		if ($count_customer==0) {
			...
			$message="
			<h1 class='text-center'>Your password has been sent.</h1>
			<h3 class='text-center'>Your password is: <b> $customer_pass </b></h3>
			";
