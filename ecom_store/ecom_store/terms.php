		  				 ...
		  				 <?php
		  				 	...
		  				 	while ($row_terms=mysqli_fetch_array($run_terms)) {
								...
								echo "<li class='nav-item'>
									    <a data-toggle='pill' class='nav-link' href='#$term_link'>$term_title</a>
									  </li>";
								}
		  				  ?>
					</ul>
			...
			<div class="col-md-9">
				<div class="box">
					<div class="tab-content">
						...
						?>
							<div id="<?php echo $term_link; ?>" class="tab-pane fade active show">
						...
						<?php
							$count_terms="select * from terms";
		  				 	...
		  				 	while ($row_terms=mysqli_fetch_array($run_terms)) {
								...
								$term_link=$row_terms['term_link'];
								$term_desc=$row_terms['term_desc'];
								echo "<div id='$term_link' class='tab-pane fade'>
								<h2> $term_title</h2>
								<p>$term_desc</p>
									 </div>";
								}
